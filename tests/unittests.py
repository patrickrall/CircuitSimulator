...
if len(tests) == 0: print("[\033[93mSkipped\033[0m] Shrink")
    ...
    if failed == 0: print("[\033[92mPassed\033[0m] Shrink: %d tests in " % len(tests) + str(datetime.now() - starttime))
...
if len(tests) == 0: print("[\033[93mSkipped\033[0m] Extend")
    ...
    if failed == 0: print("[\033[92mPassed\033[0m] Extend: %d tests in " % len(tests) + str(datetime.now() - starttime))
...
if len(tests) == 0: print("[\033[93mSkipped\033[0m] MeasurePauli")
    ...
    if failed == 0: print("[\033[92mPassed\033[0m] MeasurePauli: %d tests in " % len(tests) + str(datetime.now() - starttime))
...
if len(tests) == 0: print("[\033[93mSkipped\033[0m] Unpack")
    ...
    if failed == 0: print("[\033[92mPassed\033[0m] Unpack: %d tests in " % len(tests) + str(datetime.now() - starttime))
